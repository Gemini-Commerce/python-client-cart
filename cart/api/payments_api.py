...
class PaymentsApi:
    ...
    def list_payment_methods(
        ...
        :param body: (required)
        :type body: CartListPaymentMethodsRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CartListPaymentMethodsResponse",
            '400': "RpcStatus",
            '404': "RpcStatus",
            '409': "RpcStatus",
            '500': "RpcStatus",
    ...
    def list_payment_methods_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CartListPaymentMethodsResponse]:
        """List Payment Methods
    ...
    def _list_payment_methods_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/cart.Cart/ListPaymentMethods',
    ...
    def set_set_payments(
        ...
        :param body: (required)
        :type body: CartSetPaymentsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_set_payments_serialize(
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def set_set_payments_with_http_info(
        self,
        body: CartSetPaymentsRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CartSetPaymentsResponse]:
        """Set SetPayments
    ...
    @validate_call
    def set_set_payments_without_preload_content(
        self,
        body: CartSetPaymentsRequest,
        _request_timeout: Union[
            None,
    ...
    def _set_set_payments_serialize(
        self,
        body,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/cart.Cart/SetPayments',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
