...
class CartProductConfigurationStepOption(BaseModel):
    ...
    price_variation: Optional[CartMoney] = Field(default=None, alias="priceVariation")
    weight_variation: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="weightVariation")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of price_variation
        if self.price_variation:
            _dict['priceVariation'] = self.price_variation.to_dict()
