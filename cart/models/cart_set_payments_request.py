...
class CartSetPaymentsRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "cartId", "payments"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CartSetPaymentsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CartSetPaymentsRequest from a dict"""
        if obj is None:
            return None
