...
class CartGetActiveCartByCustomerRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantId", "customerGrn", "channel", "market", "currency"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CartGetActiveCartByCustomerRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CartGetActiveCartByCustomerRequest from a dict"""
        if obj is None:
            return None
