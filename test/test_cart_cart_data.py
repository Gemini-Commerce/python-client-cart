...
class TestCartCartData(unittest.TestCase):
    """CartCartData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartCartData:
        """Test CartCartData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CartCartData`
        """
        model = CartCartData()
        if include_optional:
            return CartCartData(
                ...
                subtotals = [
                    cart.models.cart_cart_subtotal.cartCartSubtotal(
                        code = 'UNKNOWN', 
                        value = cart.models.cart_money.cartMoney(
                            units = '', 
                            micros = 56, ), )
                    ],
                total = cart.models.cart_money.cartMoney(
                    units = '', 
                    micros = 56, ),
