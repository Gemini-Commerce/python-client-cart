...
class TestCartGetCartResponse(unittest.TestCase):
    """CartGetCartResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartGetCartResponse:
        """Test CartGetCartResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CartGetCartResponse`
        """
        model = CartGetCartResponse()
        if include_optional:
    ...
    def testCartGetCartResponse(self):
        """Test CartGetCartResponse"""
