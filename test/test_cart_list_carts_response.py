...
class TestCartListCartsResponse(unittest.TestCase):
    """CartListCartsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CartListCartsResponse:
        """Test CartListCartsResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CartListCartsResponse`
        """
        model = CartListCartsResponse()
        if include_optional:
            return CartListCartsResponse(
                carts = [
                    cart.models.cart_cart_data.cartCartData(
                        id = '', 
                        grn = '', 
                        channel = '', 
                        market = '', 
    ...
    def testCartListCartsResponse(self):
        """Test CartListCartsResponse"""
